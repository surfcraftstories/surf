...
export const categories: CategoryContent[] = [
  ...
  },
  {
    ...
    images: [
      ...
      { src: "/projects/crossbody/2026/49.png", alt: "Czarno-niebieski phone strap crossbody midnight rave ułożony na jasnym kamiennym tle", label: "midnight rave" },
      { src: "/projects/crossbody/2026/50.png", alt: "Czarny phone strap crossbody midnight rave noszony z przodu z przypiętymi kluczami", label: "Z kluczami" },
      { src: "/projects/crossbody/2026/51.png", alt: "Czarny phone strap crossbody midnight rave noszony z przodu z telefonem", label: "Z telefonem" },
      { src: "/projects/crossbody/2026/52.png", alt: "Czarno-niebieski phone strap crossbody midnight rave noszony na plecach", label: "Z tyłu" },
